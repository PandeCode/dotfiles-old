...
rm -fr ~/.config/clangd ~/.config/fish ~/.config/fontconfig ~/.config/i3 ~/.config/gtk-2.0 ~/.config/gtk-4.0 ~/.config/kitty ~/.config/polybar ~/.config/i3status ~/.config/rofi ~/.config/gtk-3.0 ~/.config/picom ~/.config/alacritty
